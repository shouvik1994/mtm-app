...
class YoutubeFeed extends \TYPO3\CMS\Scheduler\Task\AbstractTask {
	...
	public function execute() {
		...
		return $mtmUtil->youtubeImport($this->youtubeKey,$this->youtubeChannelId,$extConfig['youtubeStorageId']);
	}
