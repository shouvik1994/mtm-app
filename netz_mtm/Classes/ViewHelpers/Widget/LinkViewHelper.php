<?php
namespace Netz\NetzMtm\ViewHelpers\Widget;
...
class LinkViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractTagBasedViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('action', 'string', 'Method to be used for query string');
        $this->registerArgument('arguments', 'array', 'Method to be used for query string');
        $this->registerArgument('section', 'string', 'Method to be used for query string');
        $this->registerArgument('format', 'string', 'Method to be used for query string');
         $this->registerArgument('ajax', 'bool', 'Method to be used for query string');
    }
